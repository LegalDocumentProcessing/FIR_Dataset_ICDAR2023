...
```
  ...
  (3) Police Station : Name of the police station that is responsible for investigating the particular incident  
...
## Repo Organization
```
- FIR_images_v1 - FIR documents
- FIR_details.json - annotated ground truth of FIR entities
```
